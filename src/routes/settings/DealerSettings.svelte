...
<div class="tabs tabs-bordered">
  <button on:click={() => (showTabIndex = 0)} class="tab" class:tab-active={showTabIndex === 0}>Allgemein</button>
  <button on:click={() => (showTabIndex = 1)} class="tab" class:tab-active={showTabIndex === 1}>Adresse</button>
  <button on:click={() => (showTabIndex = 2)} class="tab" class:tab-active={showTabIndex === 2}>Profilbild</button>
</div>
{#if showTabIndex === 0}
