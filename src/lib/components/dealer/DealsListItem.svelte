<script lang="ts">
  ...
  import DoubleRightArrowIcon from "$lib/components/ui/icons/DoubleRightArrowIcon.svelte";
  ...
  <div class="flex grow flex-col">
    {#if showCompanyName}
      <div class="flex items-center justify-between bg-[#232b2e] px-2 py-0.5">
        <a href="/dealer/{deal.dealer_id}" class="flex items-center text-sm text-[#b2b2b2]">
          {deal.username}
        </a>
